...
- **Attribution** — You must give appropriate credit to Andrew Hagan, provide a link to this repository, and indicate if changes were made.

**Citation format:**
```
Hagan, Andrew. (2026). Rural Australia Healthcare: Research Report.
Retrieved from https://github.com/Peace-png/research-rural-australia-healthcare
```
